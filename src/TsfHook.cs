  ...
  internal static class TsfHook {
    ...
    public static void Init() {
      ...
      try {
        ...
        string dll = FindDll("gll_tsf_hook64_v16.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v15.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v14.dll");
        ...
        if (dll == null) dll = FindDll("gll_tsf_hook64_v9.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v8.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v7.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v6.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v5.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v4.dll");
        if (dll == null) dll = FindDll("gll_tsf_hook64_v3.dll");
